...
class RToolsHCK
  ...
  def install_driver_replacement_list(r_directory, windows_path)
    {
  ...
  def get_custom_command(r_directory, windows_path, custom_cmd)
    replace_command(custom_cmd, install_driver_replacement_list(r_directory, windows_path))
  end
  ...
  def do_install_machine_driver_package(machine,
    ...
    install_driver_replacement_list(r_directory, windows_path)
  end
